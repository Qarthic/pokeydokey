...
suffix = ['claw', 'tooth', 'fang', 'paw', 'talon', 'tail', 'feather', 'wing', 'fist', 'foot', 'digon', 'rax', 'dog', 'fox', 'cat', 'lion', 'monkey', 'eagle', 'parrot']
...
growl = Buff_Debuff(40, "Growl", False, "Foe", 1, "Attack")
